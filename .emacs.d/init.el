...
(use-package jtsx
	...
	:bind (:map jtsx-tsx-mode-map
							("C-i r" . jtsx-rename-jsx-element)
							("C-i w" . jtsx-wrap-in-jsx-element)
							("C-i o" . jtsx-jump-jsx-opening-tag)
							("C-i c" . jtsx-jump-jsx-closing-tag)
							("C-i u" . jtsx-unwrap-jsx)
							("C-i d n" . jtsx-delete-jsx-node)
							("C-i d a" . jtsx-delete-jsx-attribute))
	:custom
	(js-indent-level 2)
